...
#line_train = root_path + 'IAM/split/trainset_shuf_trainid.txt' #For train wid
line_train = root_path + 'IAM/split/trainset.txt'
line_test = root_path + 'IAM/split/testset.txt'

#line_val1 = root_path + 'IAM/split/trainset_shuf_cvid.txt' #For train wid
line_val1 = root_path + 'IAM/split/validationset1.txt'
...
def gather_iam_line(set='train'):
    ...
    for line in open(gtfile):
        if not line.startswith("#"):
            ...
            #if (set =='train' or set =='val'):   #For train wid
