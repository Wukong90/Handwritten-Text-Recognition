...
(1)If you only need the backbone recognition network in ![Fig.](https://github.com/Wukong90/Handwritten-Text-Recognition/blob/main/imgs/baselines.jpg), just run the train_CTC_HAM_Vis_Contex.py;
